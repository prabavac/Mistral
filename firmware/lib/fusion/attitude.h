// attitude.h: attitude estimator for Mistral (lib/fusion)
//
...
//   rotation about X "roll", so r1/r2 sidestep both names.
//
...
// before both estimators, since Fusion at gain 0.5 would otherwise hold ~2° of tilt per 1 °/s.
//
// Yaw is RATE ONLY. There is no magnetometer on this build, so absolute heading is
// unobservable, so do not estimate or control a yaw angle.
#pragma once
